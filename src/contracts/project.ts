...
/**
 * Parameters for the server-only Oxylabs residential collection path. They are
 * persisted with the project so scheduled research uses the exact owner-chosen
 * scope instead of a mutable browser request.
 */
